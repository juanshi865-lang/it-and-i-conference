window.ITIPapers = [
  {
    id: "jing-li-adaptive-strategy-optimization-iti-2024",
    title: "Adaptive Strategy Optimization for Long-Horizon Multi-Channel B2B Campaigns",
    authors: ["Jing Li"],
    affiliations: [],
    track: "Implementation Management",
    secondaryTrack: "Data Systems and Analytics",
    articleType: "Full research article",
    status: "Published in IT&I 2024 Digital Proceedings",
    year: "2024",
    publicationDate: "November 20, 2024",
    proceedings: "IT&I 2024 - XI International Scientific Conference \"Information Technology and Implementation\"",
    sourceBasis: "CV-listed registered work; Fortify campaign-analysis and customer-engagement duties; Green City market-research duties.",
    fullTextUrl: "papers/jing-li-adaptive-strategy-optimization.html",
    ...
    sections: [
      ...
      {
        heading: "4. Multi-Channel Coordination",
        body: [
          "B2B engagement requires coordination across email, website, webinars, events, social channels, sales outreach, partner touchpoints, customer success interactions, and executive communication. The framework assigns each channel a role. Broad digital channels support awareness and education. Sales and partner channels support diagnosis and validation. Customer success channels support adoption, renewal, and expansion. Executive channels support strategic alignment and urgency creation.",
          "The framework also introduces channel saturation and fatigue controls. More contact is not always better. A high-value account can disengage if messaging becomes repetitive or poorly timed. Adaptive optimization therefore incorporates negative feedback signals such as nonresponse, meeting cancellation, content abandonment, or stakeholder silence."
        ]
      },
      {
        heading: "5. Governance and Human Review",
        body: [
          "Because B2B campaigns involve relationship judgment, the framework requires human review at defined thresholds. Automated recommendations should be explainable: the model must show which journey-state indicators, response signals, and constraints led to the recommended action. Account teams can accept, override, or defer a recommendation, and the override reason becomes part of the learning record.",
      ...
      {
        heading: "8. Practical Implications",
        body: [
